...
def _hard_gates(
    ...
    return bool(
        ...
        and float(chemistry["chemical_relevance"]) >= float(thresholds["chemical_relevance_min"])
        and float(chemistry["scientific_correctness"]) >= float(thresholds["scientific_correctness_min"])
        and float(chemistry["operational_completeness"]) >= float(thresholds["operational_completeness_min"])
