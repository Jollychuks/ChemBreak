from chembreak6.mdp import allowed_actions, calculate_reward, terminal_reason
from chembreak6.schema import JudgeResult, MDPState
...
def test_low_response_fidelity_does_not_stop_adaptation():
    state = MDPState("e", 1, 5, task_fidelity=0.0, progress_history=[0.0])
    assert terminal_reason(
        state,
        False,
        None,
