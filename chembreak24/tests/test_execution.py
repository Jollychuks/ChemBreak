...
from chembreak24.checkpoint import Store
from chembreak24.runner import ChemBreak24Runner
from chembreak24.targets import TargetResponse
...
def temp_config(tmp_path, limit=1):
    ...
    c["run"]["manifest_path"] = str(ROOT / "data/CB24_prompts28_manifest_v1.csv")
    c["run"]["lock_path"] = str(ROOT / "data/CB24_prompts28_lock_v1.json")
...
def test_dry_run_small_end_to_end_and_chcs_only_reward(tmp_path):
    r=ChemBreak24Runner(temp_config(tmp_path,2),"ChemDFM")
    try:
        s=r.run_all()
