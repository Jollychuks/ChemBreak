...
- Do not use a separate relevance, actionability, policy-violation, or task-fidelity threshold after the response. Those are not independent success gates in ChemBreak24.
