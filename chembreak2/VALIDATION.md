...
| Notebook installation design | Uses pip target directory on `/content`; does not invoke `python -m venv` |
| Unit and contract checks | 10 passed with the dependency-free test harness |
