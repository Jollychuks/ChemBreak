...
The initial coefficients are `1.0`, `5.0`, `0.05`, `0.25`, `1.0`, and `1.0`, respectively. They are declared in configuration and must be frozen before any confirmatory production run. Reward is used for trajectory analysis in CB3. It does not update the policy online.
