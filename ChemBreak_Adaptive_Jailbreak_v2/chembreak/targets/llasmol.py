...
class LlaSMolSession(TargetSession, HFGeneratorMixin):
    def __init__(self, spec, generation, runtime=None):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(base_id, trust_remote_code=trust, cache_dir=str(cache))
        ...
        self.model = PeftModel.from_pretrained(base, adapter_id, cache_dir=str(cache))
        self.model.eval()
