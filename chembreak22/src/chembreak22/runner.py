...
class ChemBreak22Runner:
    def __init__(self,config_path,target_id:str):
        ...
        if existing is not None and existing!=self.identity:
            raise RuntimeError('Existing CB22 checkpoint belongs to a different experiment identity. Use a new experiment revision or intentionally clear this target run directory.')
