...
class Store:
    ...
    def save_turn_with_learning(self,policy_snapshot: dict[str,Any],evidence_snapshot: dict[str,Any],trajectory_snapshot: dict[str,Any]|None=None,**r):
        with self.db:
            self._insert_turn(r)
            ...
            if trajectory_snapshot is not None:
                self.db.execute('INSERT OR REPLACE INTO meta(key,value) VALUES(?,?)',('training_trajectory_snapshot',self._encode(trajectory_snapshot)))
