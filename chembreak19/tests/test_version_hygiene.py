...
def _prior_tokens():
    tokens=[]
    for i in range(1,19):tokens.extend([f'chembreak{i}_',f'chembreak{i}.',f'chembreak{i}-',f'chembreak{i}/',f'cb{i}_',f'cb{i}.',f'cb{i}-',f'cb{i}/',f'/content/chembreak{i}_storage'])
    return tuple(tokens)

def test_cb19_has_no_prior_runtime_names_or_artifact_files():
