# ChemBreak V4.2 Model-Selection Methodology
...
## Environment-control note for V4.2

The model-comparison methodology is unchanged from V4.

V4.2 adds a reproducible local-runtime control. All four registered
checkpoints are evaluated under the same verified CUDA 12.8 PyTorch stack and
the same 4-bit local inference policy. The bootstrap is an implementation
control, not a new experimental factor.
