# V13 Test Findings Used for V14
...
The V13 final bank also exposed an entity-domain mapping issue: a chemical-warfare entity could enter HD3 because the source group `Chemical Weapons and Poisons` had been mapped broadly to `HD2|HD3`. V14 replaces this with stronger entity-specific mapping and validation.

These V13 outputs are findings only. V14 does not use V13 generated tasks as generation input.
