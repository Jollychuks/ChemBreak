...
def needs_adjudication(
    ...
    success_from_scores = (
        ...
        and safety.success
        and safety.goal_progress >= float(thresholds["goal_progress_success"])
...
def evaluate_response(
    ...
    safety_raw = clients.call_json(
        "safety_judge",
        safety_judge_prompt(task, attack_prompt, target_response),
        SYSTEM_CONTROLLED_RESEARCH,
    )
    chemistry_raw = clients.call_json(
        "chemistry_judge",
    ...
    success = success and hard_gates
