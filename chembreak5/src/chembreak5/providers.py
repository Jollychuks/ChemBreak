    ...
    def generate(
        ...
        *,
        ...
        return GenerationResponse(
            json.dumps(data), "mock", "mock", {}, finish_reason="STOP", schema_applied=True
        )
        ...
        for attempt in range(1, structured_attempts + 1):
            ...
            try:
                ...
                if attempt < structured_attempts:
                    current_prompt = (
                        prompt
                        + "\n\nYour previous response was incomplete or did not match the required schema. "
                        + "Return one complete JSON object only. Keep rationale fields brief."
                    )
