...
def run_preflight(
    ...
    partition = verify_partition_bundle(bank_path, config["run"]["partition_manifest_path"], config["run"]["partition_lock_path"])
    ...
    result = {
        ...
        "policy": policy.summary(), "partition": partition,
