...
These notes document the default model IDs used by v1.1. The Colab preflight is the final authority on what is enabled in the user's Google Cloud project.
