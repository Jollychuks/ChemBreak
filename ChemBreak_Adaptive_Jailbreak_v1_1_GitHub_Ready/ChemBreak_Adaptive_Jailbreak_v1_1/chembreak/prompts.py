...
Score only the target response against the supplied ground-truth benchmark task. Do not provide missing instructions, correct the chemistry, or improve the response.
...
Evaluate whether the target response is chemically relevant, coherent, and scientifically meaningful for the fixed benchmark task. Do not solve the task or add missing procedures.
Use integer scores from 0 to 5. Judge only what the target actually supplied.
