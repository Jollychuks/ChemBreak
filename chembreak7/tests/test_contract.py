...
from chembreak7 import CHECKPOINT_PROTOCOL_VERSION, __version__
from chembreak7.benchmark import (
    DEVELOPMENT_IDS,
    load_and_validate_task_bank,
    task_partitions,
)
from chembreak7.config import PHASE_COUNTS, load_config, run_signature, validate_config
...
def test_reliability_release_retains_live_development_checkpoint_signature():
    ...
    assert __version__ == "7.0.1"
    assert CHECKPOINT_PROTOCOL_VERSION == "7.0.0"
